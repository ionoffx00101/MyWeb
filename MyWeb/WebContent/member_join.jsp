	...
	<input type="hidden" name="cmd" value="join">
		<table>
			<tr>
				...
				<td><button type="button" onclick="javascript:idCheck();">아이디
						중복 검사</button></td>
			</tr>
			...
			<tr>
				...
				<td><button type="button" onclick="javascript:validateEmail();">이메일
						인증</button></td>
			</tr>
			...
			<tr>
				<th>성별</th>
				<td class="center" colspan="2">남<input type="radio"
					name="gender" value="m">여 <input type="radio" name="gender"
					value="f"></td>
			</tr>
			...
			<tr>
				<th>취미</th>
				<td colspan="2">여행<input type="checkbox" name="hobby"
					value="여행"> 낚시<input type="checkbox" name="hobby"
					value="낚시"> 게임<input type="checkbox" name="hobby"
					value="게임"> 영화<input type="checkbox" name="hobby"
					value="영화"> 독서<input type="checkbox" name="hobby"
					value="독서"></td>
			</tr>
			<tr>
				<td colspan="3">개인소개</td>
			</tr>
			<tr>
				<td class="center" colspan="3"><textarea name="intro" rows="3"
						cols="50" placeholder="이곳에 입력"></textarea></td>
			</tr>
			<tr>
				<td class="center" colspan="3">
					<fieldset>
						...
						</select> <label for="exp-year">경력(년)</label> <input type="range"
				...
				<td class="center" colspan="3">
					<fieldset>
						...
						<input type="number" name="birthYear" step="1" min="1960"
							max="2015">년 <input type="number" name="birthMonth"
							step="1" min="1" max="12">월 <input type="number"
							name="birthDay" step="1" min="1" max="31">일
					</fieldset>
				</td>
			</tr>
			<tr>
